...
import { ArrowLeft, ExternalLink, Github, Bot, Smartphone, Zap, FileText, CreditCard, TrendingUp } from "lucide-react";
import { Link } from "react-router-dom";
import FighterBackground from "@/components/FighterBackground";
import Navbar from "@/components/Navbar";

const features = [
  { icon: Bot, title: "Gemini AI Chatbot", desc: "Gemini 2.0 Flash powered chatbot for instant business assistance and natural language invoice creation via chat interface." },
  { icon: FileText, title: "Smart Invoice Generation", desc: "AI suggestions and intelligent client data extraction from business cards for rapid invoice creation." },
  { icon: TrendingUp, title: "Payment Prediction", desc: "Machine learning analytics to predict payment timelines and manage cash flow proactively." },
  { icon: Zap, title: "Next.js 15 SSR", desc: "Migrated to Next.js 15 with Server-Side Rendering for lightning-fast page loads and superior SEO." },
  { icon: CreditCard, title: "Client & Payment Tracking", desc: "Comprehensive client management with payment tracking, status monitoring, and automated reminders." },
  { icon: Smartphone, title: "Fully Responsive", desc: "Mobile-first approach with optimized layouts, collapsible navigation, and touch-friendly interfaces for all devices." },
];
        ...
        <div className="container mx-auto px-6 max-w-5xl">
          ...
          <motion.div initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }}>
            ...
            <p className="text-muted-foreground text-lg leading-relaxed max-w-2xl mb-8">
              A professional full-stack invoicing solution powered by AI. Built on Next.js 15 with Gemini 2.0 Flash integration for smart invoice generation, client management, and payment prediction analytics.
            </p>
      ...
      <section className="py-24">
        <div className="container mx-auto px-6 max-w-5xl text-center">
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            <h2 className="font-display text-4xl font-bold uppercase mb-6">See It In <span className="energy-gradient-text">Action</span></h2>

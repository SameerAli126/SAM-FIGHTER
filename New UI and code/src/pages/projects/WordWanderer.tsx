...
import { ArrowLeft, ExternalLink, Github, Star, Zap, Globe, Mic, BarChart3, Trophy, Moon } from "lucide-react";
import { Link } from "react-router-dom";
import FighterBackground from "@/components/FighterBackground";
import Navbar from "@/components/Navbar";

const features = [
  { icon: Trophy, title: "XP & Streak System", desc: "Earn experience points for completing lessons and maintain daily learning streaks with visual indicators." },
  { icon: Star, title: "Achievement System", desc: "Unlock badges and rewards for milestones. Compete with other learners on global leaderboards." },
  { icon: BarChart3, title: "Progress Analytics", desc: "Detailed learning statistics and progress visualization with spaced repetition for better retention." },
  { icon: Zap, title: "Adaptive Difficulty", desc: "Multiple question types including multiple choice, translation, and audio recognition that adapt to your pace." },
  { icon: Mic, title: "Voice Recognition", desc: "Practice pronunciation with real-time audio exercises and instant feedback on accuracy." },
  { icon: Globe, title: "Chinese (Mandarin)", desc: "Complete course with Pinyin and Hanzi. Learn language with cultural context and insights." },
  { icon: Moon, title: "Dark / Light Mode", desc: "Customizable theme preferences with WCAG compliant design and offline support." },
];
        ...
        <div className="container mx-auto px-6 max-w-5xl">
          ...
          <motion.div initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }}>
            ...
            <p className="text-muted-foreground text-lg leading-relaxed max-w-2xl mb-8">
              A modern, gamified language learning platform inspired by Duolingo. Built with cutting-edge web technologies to make language acquisition engaging, effective, and fun.
            </p>
      ...
      <section className="py-24">
        <div className="container mx-auto px-6 max-w-5xl text-center">
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            <h2 className="font-display text-4xl font-bold uppercase mb-6">Try It <span className="energy-gradient-text">Live</span></h2>
